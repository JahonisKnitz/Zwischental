...
const CARD_DESC_FALLBACK = {
  ...
  minus2_attackers:   '−2 Angreifer vor jedem Überfall',
  ...
  reveal_red:         'Anführer ist immer einsehbar für Besitzer',
  free_build:         'Kostenlos bauen — zählt nicht zum Baulimit',
};
const CARD_DESC_BY_ID = {
  Z31: 'Punkte = roter Würfel × 3',
  Z34: 'Punkte = Siedlungs-Level × 3',
  Z4:  'Fragil, Punkte = Summe aller Verteidigungswerte in der Siedlung',
  Z5:  'Fragil, Punkte = Anzahl geplünderter Gebäude × 3',
