...
const BUILDINGS = [
  ...
  {id:'W14', name:'kleiner Händler', cat:'winter', pts:3, def:1, res:'holz', upgrade:false, special_mechanic:'dual_res_nahrung', cap:2},
  ...
  {id:'F8', name:'kleiner Händler', cat:'spring', pts:3, def:1, res:'holz', upgrade:false, special_mechanic:'dual_res_nahrung', cap:2},
  ...
  {id:'SO6', name:'Holzbörse', cat:'summer', pts:{type:'res*',res:'holz',factor:2}, def:2, res:'holz', upgrade:false, cap:2},
  ...
  {id:'H2', name:'Holzhändlerfeste', cat:'autumn', pts:{type:'res*',res:'holz',factor:3}, def:3, res:'holz', upgrade:false, cap:3},
  {id:'H3', name:'Müllergilde', cat:'autumn', pts:{type:'res*',res:'nahrung',factor:3}, def:2, res:'nahrung', upgrade:false, cap:2},
